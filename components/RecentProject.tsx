    ...
    return (
        <div className="py-20" id="projects">
           <h1 className="heading">
            ...
            <span className="text-purple">Research</span>
           </h1>
                ...
                {projects.map(({id,title,des,img,iconLists,link})=>(
                    <div key={id} className="sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]">
                       <PinContainer title={title} href={link}>
                        ...
                        <p className="lg:text-l lg:font-normal font-light text-sm line-clamp-2 text-purple">
                            {des}
                        </p>
                        ...
                        <div className="flex item-center justify-between mt-7 mb-3">
                            ...
                            <div className="flex justify-center items-center">
                                <p className="flex lg:text-xl md:text-xs text-sm text-purple">
                                    check live site
                                    <FaLocationArrow className="ms-3" color="#CBAFCF9" />
                                </p>
                            </div>
                        </div>
